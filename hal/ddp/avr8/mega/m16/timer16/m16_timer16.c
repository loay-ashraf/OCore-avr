...
*
* Description: Enables input capture noise canceller for
*              16-bit timer module.
*
* Notes:
*
...
*
* Description: Disables input capture noise canceller for
*              16-bit timer module.
*
* Notes:
*
...
/**********************************************************************
*
* Function:    m16_timer16.checkOverflow
*
